...
int main(int argc, char **argv)
{
    ...
    std::string casePath = "/media/feiyang/sources/Dataset/MAV-dataset/V1_01_easy/mav0";
    std::string sensorCfgPath = "/media/feiyang/Documents/workSpace/test/config/cam_imu.yaml";
